...
/**
 * @typedef {object} MistSignalingConfig
 * @property {object} signaling
 * @property {"nostr"} signaling.mode
 * @property {object} signaling.nostr
 * @property {string[]} signaling.nostr.relays
 * @property {number} signaling.nostr.discoveryKind
 * @property {number} signaling.nostr.messageKind
 * @property {number} signaling.nostr.ttlSeconds
 * @property {string} signaling.nostr.inviteSalt
 * @property {string} signaling.nostr.inviteCode
 */
 ...
 *
 * @returns {MistSignalingConfig}
 */
export function mistSignalingConfig() {
    return {
        signaling: {
            mode: 'nostr',
            nostr: {
